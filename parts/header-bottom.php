  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6 col-md-4">
        ...
        <a class="qt-header-logo" href="index.php">
          <img src="resources/img/logo.png" class="img-responsive" alt="Logo Senior Garden n.o. na Slovensku">
        </a>
...
<!--            <i class="fa fa-phone fa-fw"></i>+036 6396 639-->
<!--          </div>-->
...
<!--          </div>-->
      ...
      <div class="col-sm-12 col-md-4 col-md-pull-4">
        ...
        <ul class="qt-header-social-listing">
          <li class="qt-header-social-item"><a href="https://www.facebook.com/Senior-Garden-226263754144557/"><i class="fa fa-facebook-square"></i></a></li>
